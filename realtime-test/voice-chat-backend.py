...
class VoiceChatClient:
    def __init__(self, backend_url: str):
        ...
        print("🎤 Starting Voice Chat with KellerAI Backend...")
        print("📝 Instructions:")
    ...
    async def connect_to_backend(self):
        ...
        try:
            ...
            print("   3. Port 8081 is accessible")
            sys.exit(1)

    async def handle_backend_messages(self):
        """Handle messages from the backend server."""
        audio_buffers = []
        ...
        try:
            async for message in self.websocket:
                try:
                    ...
                    print("❌ Error parsing message from backend")
